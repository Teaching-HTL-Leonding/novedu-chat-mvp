...
// Teacher-only, READ-ONLY view of one conversation held under a tutor code. Any
// effective teacher may open any code's conversations (`getTutorCode`; RBAC
// planned); `getConversationMessages` additionally re-checks the thread belongs
// to the code. There is no chat input — the same CopilotKit component that paints
// the live chat renders the transcript, nothing more.
