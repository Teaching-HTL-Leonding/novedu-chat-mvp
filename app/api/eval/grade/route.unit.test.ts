...
// The teacher-only grader-eval route: the bearer gate stays REAL over a stubbed
// `getSession` while Mastra is mocked like in `lib/quiz-actions.unit.test.ts`. Pins the
