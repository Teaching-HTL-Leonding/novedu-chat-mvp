...
- Fragments: pulling in reusable, named pieces of prompt and supplying their values, and
  when that is worth it versus just writing instructions directly.
...
- A fragment library has to be reachable at a public URL, and validating a tutor checks
  every fragment in a library it references, even unused ones.
