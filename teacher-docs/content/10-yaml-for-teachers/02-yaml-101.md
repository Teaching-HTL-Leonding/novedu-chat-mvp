...
<!--
  ...
  Edit the chapter prompt in teacher-docs/prompts/10-yaml-for-teachers/02-yaml-101.prompt.md and regenerate.
-->
...
Instructions, descriptions, and [[prompt|prompts]] are usually several paragraphs long. YAML handles them with a pipe character (`|`) after the key: everything indented below it is one block of text, kept exactly as you type it, line breaks and blank lines included.
