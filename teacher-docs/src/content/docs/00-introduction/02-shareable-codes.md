---
title: What is a shareable code
description: The short link that opens one activity for your class, how you get one, what students do with it, and which settings it carries.
sidebar:
  order: 2
audience: teacher
keywords: [code, shareable code, link, share, class, start page, availability window, anonymous]
related:
