---
title: Deleting a code
description: Remove codes you no longer need, and know that a code's conversations, saved texts, and statistics are deleted with it, permanently.
sidebar:
  order: 5
audience: teacher
keywords: [delete, remove, delete selected, permanent, clean up, tidy, statistics, conversations, expired]
related:
