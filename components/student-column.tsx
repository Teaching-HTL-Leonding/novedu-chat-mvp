...
export interface StudentRow {
  ...
  userId: string;
  /** Its `novedu_user` resolution; `null` when that student has no row yet. */
...
//
// The user id is the fallback label for a student who has no `novedu_user` row yet, and
...
// a raw user id would otherwise widen the whole table. The
