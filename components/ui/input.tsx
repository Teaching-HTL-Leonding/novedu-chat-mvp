...
export const inputVariants = cva(
  "h-9 rounded-lg border border-foreground/25 bg-background px-3 text-foreground text-sm placeholder:text-foreground/40 focus-visible:outline-2 focus-visible:outline-ring focus-visible:outline-offset-2 disabled:cursor-not-allowed disabled:opacity-50",
);
